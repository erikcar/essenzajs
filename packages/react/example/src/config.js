...
export function ConfigureApp(app, init){
    ...
    app.configureType({
        users:{
            fields: { id: int, name: string, surname: string, email: string, password: string, itype: int, username: string, nusername: string, nemail: string, emailvalid: bool, phone: string, phonevalid: bool, twofactor: bool, idplatform: int, businessname: string, locked: bool, dlog: date, dlast: date, cf: string, vatnumber: string, street: string, num: string, locality: string, code: string, city: string, url: string, complete: bool },
